...
class AddMovieFormRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'poster_image'=>'required|dimensions:min_width=280,min_height=410|mimes:jpg,jpeg,png',
            'screenshot1_image'=>'required|dimensions:min_width=1280,min_height=680|mimes:jpg,jpeg,png',
            'screenshot2_image'=>'required|dimensions:min_width=1280,min_height=680|mimes:jpg,jpeg,png',
