...
class AddMovieFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'screenshot1_image'=>'dimensions:min_width=1280,min_height=450|mimes:jpg,jpeg,png',
            'screenshot2_image'=>'dimensions:min_width=1280,min_height=450|mimes:jpg,jpeg,png',
            'movie_length'=>'string',
            'movie_size'=>'string',
