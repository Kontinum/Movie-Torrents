<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12 browse-movies">
                ...
                <div class="col-lg-3 col-lg-offset-0 col-md-5 col-md-offset-1 col-sm-5 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                    <div class="movie">
                        <a href="{{route('browseMovies',['movie_id'=>$movie->id])}}" class="movie-link">
                            <figure>
                                <img class="img-responsive image-list" src="/images/movies/{{$movie->pictures->images_directory_name.'/' .$movie->pictures->poster_picture}}" alt="">
